...
class showfinancial extends StatelessWidget {
  final Receipt myreciept;

  const showfinancial({super.key, required this.myreciept});
  @override
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              child: Text(
                'اسم المستأجر:  ${myreciept.tenantName}',
            ...
            Container(
              ...
              decoration: BoxDecoration(
                  ...
                  borderRadius: BorderRadius.circular(5)),
              child: Text(
                'رقم هاتف المستأجر: ${myreciept.tenantPhone}',
                textAlign: TextAlign.right,
                style: TextStyle(fontSize: 12.5, color: Colors.black87),
              ),
            ),
