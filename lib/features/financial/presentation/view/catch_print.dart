        ...
        return pw.Container(
            ...
            child: pw.Column(
                ...
                children: [
                  ...
                  pw.Text(
                      'تم استلام مبلغ وقدره ${data.totalAmount}  ${cashhelper.getdata(key: "currency")} من السيد/ ${data.tenantName} بدلا عن ايجار ......................... عنوانها ${data.state!.addressDetails} عمارة رقم ${data.state!.buildingNumber!} شقة رقم ${data.state!.apartmentNumber}  وللمدة الزمنية من ${data.contractDateFrom}  الي  ${data.contractDateTo}',
                      style: pw.TextStyle(
