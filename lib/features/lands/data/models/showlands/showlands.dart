...
class Showlands extends Equatable {
  final Data? data;
  final num? code;
  final String? message;
  final bool? status;

  const Showlands({this.data, this.code, this.message, this.status});

  factory Showlands.fromJson(Map<String, dynamic> json) => Showlands(
        data: json['data'] == null
            ? null
